...
== Verify all console link services
...
for svc in \n
  ...
  "rhods-dashboard-redhat-ods-applications" \n
  "grafana" \n
  "kiali-openshift-cluster-observability-operator" \n
  "vault-vault" \n
  "vp-gitops-server-vp-gitops" \n
  "showroom-showroom"; do
...
.Expected: all services return 200, 302 (redirect to login), or 307 (redirect to UI)
...
rhods-dashboard-redhat-ods-applications             302

grafana                                            200

kiali-openshift-cluster-observability-operator      200
