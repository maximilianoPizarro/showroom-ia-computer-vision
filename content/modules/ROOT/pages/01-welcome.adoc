...
Welcome to the **AI Computer Vision at the Edge** workshop. In ~70 minutes you deploy a personal NeuroFace instance, explore OpenShift AI, discover RHCL Gateway objects, and test inference with curl.
